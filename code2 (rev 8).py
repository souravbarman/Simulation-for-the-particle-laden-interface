...
numpy.savetxt('Initial_R.txt', R, delimiter=',')
...
Upper_R = numpy.loadtxt('Equilibrated Upper_R.txt', delimiter=',')
Lower_R = numpy.loadtxt('Equilibrated Lower_R.txt', delimiter=',')
Upper_V = numpy.loadtxt('Equilibrated Upper_V.txt', delimiter=',')
Lower_V = numpy.loadtxt('Equilibrated Lower_V.txt', delimiter=',')

Bulk_R = numpy.loadtxt('Equilibrated Bulk_R.txt', delimiter=',')
Bulk_V = numpy.loadtxt('Equilibrated Bulk_V.txt', delimiter=',')
...
numpy.savetxt('Non Equilibrated final position.txt', R, delimiter=',')
numpy.savetxt('Non Equilibrated final velocity.txt', V, delimiter=',')  
